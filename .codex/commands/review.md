...
> 체크리스트 기준 상세 → **AGENTS.md — 코딩 컨벤션 섹션 참고**
...
- [ ] `XxxErrorType`이 `ErrorCode`를 구현하고 적절한 HTTP 상태 코드를 사용하는가
- [ ] Swagger import 충돌: `com.example.cowmjucraft.global.response.ApiResponse` import, Swagger `@ApiResponse`는 FQN 사용했는가
